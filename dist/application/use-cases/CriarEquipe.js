...
class CriarEquipe {
    ...
    async executar(dados) {
        ...
        const equipe = new Equipe_1.Equipe((0, uuid_1.v4)(), dados.nome, dados.pdv, dados.cidade, dados.estado, dados.gerenteNome, dados.gerenteTelefone, dados.capitaoNome, dados.capitaoTelefone, dados.temaId);
